...
if __name__ == "__main__":
  ...
  astar = parseall("test/astar_base.llvm-0")
  bzip2 = parseall("test/bzip2_base.llvm-0")
  gcc = parseall("test/gcc_base.llvm-0")
  gobmk = parseall("test/gobmk_base.llvm-0")
  h264ref = parseall("test/h264ref_base.llvm-0")
  hmmer = parseall("test/hmmer_base.llvm-0")
  lbm = parseall("test/lbm_base.llvm-0")
  libquantum= parseall("test/libquantum_base.llvm-0")
  mcf = parseall("test/mcf_base.llvm-0")
  milc = parseall("test/milc_base.llvm-0")
  namd = parseall("test/namd_base.llvm-0")
  omnetpp = parseall("test/omnetpp_base.llvm-0")
  perlbench = parseall("test/perlbench_base.llvm-0")
  povray = parseall("test/povray_base.llvm-0")
  sjeng = parseall("test/sjeng_base.llvm-0")
  soplex = parseall("test/soplex_base.llvm-0")
  sphinx = parseall("test/sphinx_livepretend_base.llvm-0")
  Xalan = parseall("test/Xalan_base.llvm-0")
  ...
  benches["gcc"] = gcc
  benches["gobmk"] = gobmk
  benches["h264ref"] = h264ref
  benches["hmmer"] = hmmer
  benches["lbm"] = lbm
  benches["libquantum"] = libquantum
  benches["mcf"] = mcf
  benches["milc"] = milc
  benches["namd"] = namd
  benches["omnetpp"] = omnetpp
  benches["perlbench"] = perlbench
  benches["povray"] = povray
  benches["sjeng"] = sjeng
  benches["soplex"] = soplex
  benches["sphinx"] = sphinx
  benches["Xalan"] = Xalan

  # kbackdoor = parseall("windows_builds/kbackdoor_all-")
  # mimikatz = parseall("windows_builds/mimikatz_all-")
  # pwdump = parseall("windows_builds/pwdump_all-")
  # nmap = parseall("linux_builds/nmap_all-")
  # sps = parseall("linux_builds/simple_port_scanner_all-")
  # benches = {}
  # benches["kbackdoor"] = kbackdoor
  # benches["mimikatz"] = mimikatz
  # benches["pwdump"] = pwdump
  # benches["nmap"] = nmap
  # benches["simple port scanner"] = sps
